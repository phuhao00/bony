...
pub fn run() {
    ...
    let app = app_menu::install(builder)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            resolve_oa_owner,
            list_relay_agents,
            list_route_eligible_agents,
            pick_route_agent,
            economy_get_leaderboard,
            economy_get_wallet,
            economy_list_orgs,
            economy_create_org,
            economy_join_org,
            economy_leave_org,
            economy_list_tenders,
            economy_suggest_tender,
            economy_publish_tender,
            economy_invite_tender_bids,
            economy_resolve_tender,
            economy_sweep_tenders,
            economy_cancel_tender,
            economy_clear_tenders,
            economy_admin_adjust_balance,
            economy_admin_adjust_reputation,
            economy_admin_set_tags,
            economy_admin_grant_achievement,
            list_managed_agents,
