        ...
        WorkflowScene {
            ...
            summary:
                "桌面 UI → ACP → Session → Sampler → Tools → turns.jsonl，对照时序图与源码锚点。"
                    .into(),
            image: Some("/repo-docs/buzz-room-local-room.png".into()),
            ...
            steps: vec![
                step(
                    ...
                    &[
                        ...
                        cref(
                            "third_party/buzz/desktop/src/features/channels/ui/codingWorkspaceSurface.ts",
                ...
                step(
                    ...
                    "Buzz channel / ACP session state",
                    &["buzz-desktop"],
                    &[
                        cref(
                            "third_party/buzz/desktop/src/features/channels/ui/useChannelAgentSessions.ts",
                            "turns.jsonl",
                            "token 用量持久化",
                        ),
                        cref(
        ...
        WorkflowScene {
            ...
            steps: vec![
                step(
                    ...
                    "desktop or pager UI",
                    &["buzz-desktop", "xai-grok-pager"],
                    &[cref(
                        "third_party/buzz/desktop/src-tauri/src/main.rs",
                        "eframe::run_native",
                        "桌面进程入口",
                    )],
                ),
        ...
        WorkflowScene {
            ...
            steps: vec![
                step(
                    ...
                    &[
                        cref(
                            "crates/codegen/bony-room-tools-mcp/src/main.rs",
