...
pub(crate) fn normalize_agent_command_identity(command: &str) -> String {
    ...
    // (also `.ps1`/`.com`) shims; all name the same runtime identity.
    let stem = [".exe", ".cmd", ".bat", ".ps1", ".com"]
        .iter()
